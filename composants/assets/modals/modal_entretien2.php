...
<div class="modal fade" id="modal-entretien2">
        ...
        <div class="modal-content">
            ...
            <form method="POST" id="formEntretien">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-4">
                            <label>Le véhicule concerné <span1>*</span1></label>
                            <div class="form-group">
                                <select class="select2" name="vehicule_id" style="width: 100%;">
                                    <?php              
                                    foreach (Home\VEHICULE::parcauto() as $key => $item) {
                                        $item->actualise();
                                        $name = $item->immatriculation." // ".$item->marque->name." ".$item->modele;
                                        ?>
                                        <option value="<?= $item->get_id() ?>"><?= $name ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
