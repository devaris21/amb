...
<div class="modal inmodal fade" id="modal-admin">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">Gestionnaire du parc AMB</h4>
                <small class="font-bold">Renseigner ces champs pour enregistrer l'administrateur</small>
            </div>
            <form method="POST" class="formShamman" classname="admin">
