...
<div class="modal inmodal fade" id="modal-sinistre-carplan">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" name="lieudrame"  required >
                                </div>
                            </div>
                        </div>
                        <div class="row">                                
                            <div class="col-sm-6">
                                <label>Date et heure du sinistre <span1>*</span1></label>
                                <div class="form-group">
                                    <input type="datetime-local" class="form-control" name="date_etablissement"  required>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-8 border-left">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <input type="text" uppercase class="form-control" name="immatriculationautre" >
                                </div>
                            </div>
                            <div class="col-sm-6">
