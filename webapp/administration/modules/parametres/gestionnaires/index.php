                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h4 class="m-b-0"><?= start0(count(Home\EMPLOYE::getAll())) ?></h4>
                                            </div>
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h4 class="m-b-0"><?= start0(count(Home\EMPLOYE::findBy(["typeadministrateur_id >="=>3]))) ?></h4>
                                            </div>
                                            <div class="col col-auto text-right">
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h4 class="m-b-0"><?= start0(count(Home\EMPLOYE::findBy(["created >="=>date("Y-m-"."01")]))) ?></h4>
                                            </div>
                                            <div class="col col-auto text-right">
                            ...
                            <div class="card">
                                <div class="card-block">
                                    <ul class="nav nav-tabs " role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-toggle="tab" href="#employes" role="tab">Tous les gestionnaires internes</a>
                                            <div class="slide"></div>
                                        </li>                                        
                                    </ul>
                                    ...
                                    <div class="tab-content card-block">
                                        ...
                                        <div class="tab-pane active" id="employes" role="tabpanel">
                                            <div class="row container">
                                                <button data-toggle="modal" data-target="#modal-employe" class="btn btn-sm btn-grd-success btn-round float-right btn_modal"><i class="fa fa-plus"></i> Ajouter un nouveau gestionnaire</button>
                                            </div><br>
                                            <div class="row">
                                                <table class="table table-hover table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($employes as $key => $employe) {
                                                            $employe->actualise(); ?>
                                                            <tr>
                                                                <td class="gras"><?= $employe->name ?> <?= $employe->lastname ?></td>
                                                                <td class="gras"><?= $employe->typeadministrateur->name ?></td>
                                                               <td class="cursor" onclick="changer(<?= $employe->get_id() ?>)"><i class="fa fa-refresh text-blue"></i></td>
                                                                <td><?= $employe->adresse ?></td>
                                                                <td><a href="mailto:<?= $employe->email ?>"><?= $employe->email ?></a></td>
                                                                <td><?= $employe->contact ?> / <?= $employe->contact2 ?></td>
                                                                <td class="cursor" data-toggle="modal" data-target="#modal-employe" onclick="modification('employe', <?= $employe->get_id() ?>)"><i class="fa fa-pencil text-blue"></i></td>
                                                                <td class="cursor" onclick="suppression_with_password('employe', <?= $employe->get_id() ?>)"><i class="fa fa-close text-red"></i></td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
                                                </table>
...
<div class="modal fade" id="modal-employe">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" class="shamman-form" classname="employe">
