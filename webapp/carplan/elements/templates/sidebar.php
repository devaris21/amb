        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="">
                ...
                <ul class="nav nav-second-level collapse">
                    <li id="demandeentretiens"><a href="<?= $this->url("carplan", "master", "demandeentretiens") ?>">Liste des demandes</a></li>
                    <li id="entretiensencours"><a href="<?= $this->url("carplan", "master", "entretiensencours") ?>">Entretiens en cours</a></li>
            ...
            <li class="">
                ...
                <ul class="nav nav-second-level collapse">
                    <li id="sinistres"><a href="<?= $this->url("carplan", "master", "sinistres") ?>">Sinistres déclarés</a></li>
