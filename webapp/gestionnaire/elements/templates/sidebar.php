                ...
                <div class="tabs-container">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="tab-1" class="tab-pane active">
                            <?php require($this->rootPath("webapp/gestionnaire/elements/templates/sidebar_master.php")) ?>
                        </div>

                        <div id="tab-2" class="tab-pane">
                            <?php require($this->rootPath("webapp/gestionnaire/elements/templates/sidebar_location.php")) ?>
                        </div>

                        <div id="tab-3" class="tab-pane">
                            <?php require($this->rootPath("webapp/gestionnaire/elements/templates/sidebar_users.php")) ?>
                        </div>
                    </div>
                </div>
            </li>
