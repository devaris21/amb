<ul class="nav metismenu" id="side-menu">
    ...
    <li>
        ...
        <ul class="nav nav-second-level collapse">
            <li id="parcauto"><a href="<?= $this->url("gestionnaire", "master", "parcauto", "parcauto") ?>">Liste des véhicules</a></li>
    ...
    <li>
        <a href="#"><i class="fa fa-fire-extinguisher"></i> <span class="nav-label">Entretiens de véhicules</span> <span class="fa arrow"></span></a>
        <ul class="nav nav-second-level collapse">
    ...
    <li class="" id="demandevehicules">
        <a href="<?= $this->url("gestionnaire", "master", "demandevehicules") ?>"><i class="fa fa-diamond"></i> <span class="nav-label">Demandes de véhicules</span></a>
    </li>
    <li class="" id="missions">
        <a href="<?= $this->url("gestionnaire", "master", "missions") ?>"><i class="fa fa-send"></i> <span class="nav-label">Missions</span></a>
    </li>
