            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                                ...
                                <div class="card bg-c-yellow text-white">
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <p class="m-b-5">Total Accessoires</p>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-c-green text-white">
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <p class="m-b-5">Catégories d'accessoires</p>
                                    ...
                                    <div class="card-block">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                ...
                                                <h4 class="m-b-0"> <h4 class="m-b-0"><?= start0(Home\ACCESSOIRE::utilises()) ?></h4></h4>
                                            </div>
                                            <div class="col col-auto text-right">
                        ...
                        <div >
                            <button class="btn bg-green btn-sm pull-left" data-toggle="modal" data-target="#modal-accessoire"><i class="fa fa-plus"></i> Ajouter un nouvel accessoire</button>
                        </div><br><br>
                                    ...
                                    <div class="tab-content card-block">
                                        <?php foreach ($types as $key => $type) {
                                            ...
                                            <div class="tab-pane " id="type<?= $type->get_id() ?>" role="tabpanel">
                                                <div class="row">
                                                    <?php foreach ($type->accessoires as $key => $accessoire) {
                                                        $accessoire->actualise(); ?>
                                                        <div class="col-md-3 accessoires">
                                                            <div class="card cursor " style="padding: 2%">
                                                                <div class="">
                                                                    <h2 class="mp3 subtitle text-green" style="font-size: 14px"><?= $accessoire->name ?></h2>
                                                                    <small><?= $accessoire->comment ?></small>
                                                                    <hr class="mp0">
                                                                    <div class="row">
                                                                        <div class="col-7">
                                                                            <span>en stock: <?= $accessoire->stock ?> pièces</span>
                                                                        </div>
                                                                        <div class="col-5">
                                                                        </div>
                                                                    </div>
            ...
            <form method="POST" class="shamman-form" classname="accessoire">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <label>Nom de l'accessoire<span1>*</span1></label>
                            <div class="form-group">
                                <input type="text" class="form-control" name="name" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <label>prix unitaire de l'accessoire<span1>*</span1></label>
                            <div class="form-group">
