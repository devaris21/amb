                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="vote-actions" style="margin-right: 6%; height: 100%">
                                                <div class="vote-icon" data-toggle="tooltip" title="<?= ($demande->typemission_id == 1)?'Mission programmée':'Mission inopinée'; ?>" >
                                                    <i class="fa fa-car <?= ($demande->typemission_id == 1)?'text-danger':'' ?>"> </i>
                                                </div>
                                            </div>
                     ...
                     <div class="row">
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="form-group">
                                <input type="number" class="form-control input-xs" min=1 value=1 name="carburant_aller" required>
                            </div>
                        </div>
                    </div>
                </div><hr>
