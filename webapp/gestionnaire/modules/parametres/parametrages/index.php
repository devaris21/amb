                ...
                <div class="pcoded-inner-content"><br><br><br>
                    ...
                    <div class="row container-fluid">
                        ...
                        <div class="col-md-3 col-sm-4">
                            <a href="<?= $this->url("administration", "parametres", "parcauto") ?>">
                                <div class="card user-widget-card bg-c-blue">
                                    <div class="card-block">
                                        <i class="fa fa-car bg-simple-c-blue card1-icon"></i>
                                        <h4>Les types</h4>
                                        <p class="cursor" >Pour les véhicules</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <a href="<?= $this->url("administration", "parametres", "types") ?>">
                                <div class="card user-widget-card bg-c-blue">
                                    <div class="card-block">
                                        <i class="fa fa-file-text-o bg-simple-c-blue card1-icon"></i>
                                        <h4>Les types</h4>
                                        <p class="cursor" >Documents & Autres</p>
                                    </div>
                                </div>
                            </a>
                        </div>
                        ...
                        <div class="col-md-3 col-sm-4">
                            <a href="<?= $this->url("administration", "parametres", "emails") ?>">
                                <div class="card user-widget-card bg-c-blue">
                                    <div class="card-block">
                                        <i class="fa fa-envelope-o bg-simple-c-blue card1-icon"></i>
                                        <h4>Les emails</h4>
                                        <p class="cursor" >Configurations</p>
                                    </div>
                                </div>
                            </a>
                        </div>
