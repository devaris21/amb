                                       ...
                                       <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <h6 class="text-muted f-w-400"><?= $gestionnaire->name() ?></h6>
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="m-b-5 f-w-600">Niveau d'Administration</p>
                                                <h6 class="text-muted f-w-400"><?= $gestionnaire->typeadministrateur->name ?></h6>
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="m-b-5 f-w-600">Login de connexion </p>
                                                <h6 class="text-muted f-w-400"><?= $gestionnaire->login ?></h6>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <h6 class="text-muted f-w-400"><?= $gestionnaire->contact ?> / <?= $gestionnaire->contact2 ?></h6>
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="m-b-5 f-w-600">Email</p>
                                                <h6 class="text-muted f-w-400"><?= $gestionnaire->email ?></h6>
                                            </div>
                                            <div class="col-sm-4">
                                                <p class="m-b-5 f-w-600">Situation Géographique</p>
                                                <h6 class="text-muted f-w-400"><?= $gestionnaire->adresse ?></h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
