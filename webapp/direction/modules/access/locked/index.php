    ...
    <div class="container text-center animated fadeInDown">
       <h1 class="logo-name text-uppercase" style="font-size: 50px; letter-spacing: 2px; margin-bottom: 5%;">session vérouillée</h1>
        ...
        <div class=" text-center">
            <div class="m-b-md">
            <img alt="image" style="width: 100px" class="rounded-circle circle-border" src="<?= $this->stockage("images", "utilisateurs", $utilisateur->image) ?>">
            </div>
            ...
            <form class="m-t offset-4 col-md-4" role="form" id="lockedForm" method="POST">
                ...
                <a href="<?= $this->url($this->section, "access", "login"); ?>" class="btn btn-xs btn-outline btn-rounded"><i class="fa fa-arrow-left"></i> Nouvelle connexion</a>
