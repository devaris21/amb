    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            <div class="col-md-6">
                ...
                <h2 class="font-bold text-uppercase"><i class="fa fa-shield"></i> direction & département</h2>

                <p>Veuillez entrer vos informations de connexion pour avoir accès à la plateforme de gestion.</p>

                <p>En cas d'oubli ou de perte de votre mot de passe, vous pouvez le recupérer à l'aide de votre email en cliquant sur <br><a href="<?= $this->url("direction", "access", "reset") ?>">J'ai oublié mon mot de passe !</a>
                </p>
            ...
            <div class="col-md-6">
                <div class="ibox-content">
                    ...
                    <form method="POST" class="m-t" role="form" id="formConnexion">
                        ...
                        <br><p class="text-center"><a href="<?= $this->url("direction", "access", "reset") ?>">
